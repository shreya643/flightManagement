...
<head>
    ...
    <title>Create Record | Flight Management System</title>
    <meta charset="utf-8">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseComponents"
                   data-parent="#exampleAccordion">
                    ...
                    <span class="nav-link-text">Paid and Unpaid Record</span>
                </a>
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i>Create Flight Record
            </div>
            <div class="card-body">
                <div class="container">
                    <form method="post" action="dashboard?pageRequest=addRecord">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" placeholder="" id="phone" name="phone" required>
                                </div>
                            </div>
                            <!--  col-md-6   -->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="amount" placeholder="Amount" name="price" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="flightDate" placeholder="dd/mm/yyyy" name="date" required>
                                </div>
